...
function LeaderboardRow({ rank, graffiti, points = 0 }: Props) {
  ...
  return (
    <div>
      {/* Large screens  */}
      <div
        className="hidden md:flex relative bg-white rounded items-center px-10"
      ...
      <div
        className="md:hidden flex relative bg-white rounded items-center px-6"
        style={{ boxShadow: '0 4px 4px 0 rgba(0, 0, 0, 0.19)' }}
      >
        <div>
          <div
            className="flex items-stretch justify-between mb-1"
            style={{ width: '100%' }}
          >
            <div>
              <div className="relative text-xs mt-6 text-ifsubtextgray tracking-widest">
                USERNAME
              </div>
          ...
          <div className="flex font-favorit  gap-x-16 gap-y-2 mb-5">
            <div>
              <div className="text-xs mt-2 text-ifsubtextgray tracking-widest">
                RANK
              </div>
              <h1 className="font-extended text-xl mt-0 break-all">
                {rankStr}
