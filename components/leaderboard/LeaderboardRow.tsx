...
function LeaderboardRow({ rank, graffiti, points }: Props) {
  ...
  return (
    <div className="bg-white border border-black rounded flex items-center px-10" style={{ boxShadow: '0 4px 4px 0 rgba(0, 0, 0, 0.19)' }}>
      <div className="font-extended text-2xl w-24">{rankStr}</div>
      <div className="flex flex-1 items-center font-extended text-2xl">
        <div className="py-3 mr-5"><FishAvatar color={avatarColor} /></div>
        <div>{graffiti}</div>
      </div>
