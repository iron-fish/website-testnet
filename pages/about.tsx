        ...
        status === STATUS.LOADING ? (
          ...
          <div className="min-h-screen flex flex-col font-favorit">
            ...
            <main className="bg-iflightorange flex-1 items-center flex flex-col">
              ...
              <div
                className={clsx('mx-3', 'px-3', 'w-full', 'lg:w-2/3', 'mb-6')}
              >
                ...
                <div className="hidden md:block">
                  ...
                  <Para>
                    Earning points places you on the Leaderboard. See how you
                    progress each week in comparison to others.
                  </Para>
                  <div className="mt-8 mb-4 block text-2xl">
                    <BasicLink href="/leaderboard">
