...
const questions: ReadonlyArray<{
...
}> = [
  {
    ...
    id: `testnet-duration`,
    answer: `Phase 2 will run from May 10, 2022 @ 12:00 PDT until November 15, 2022. The testnet will run until the Iron Fish node is stable, feature-complete, and ready for mainnet 🎉`,
  },
  {
